...
document.getElementById('reverseStringButton').addEventListener('click', function() {
    const str = document.getElementById('cadena').value;
...
document.getElementById('checkPrimeButton').addEventListener('click', function() {
    const num = parseInt(document.getElementById('primo').value);
    let isPrime = true;
    if (num <= 1) {
        isPrime = false;
    } else {
    ...
    document.getElementById('primeResult').innerText = `${num} ${isPrime ? 'es un número primo' : 'no es un número primo'}`;
});


// Eliminar Duplicados en Arreglo
document.getElementById('removeDuplicatesButton').addEventListener('click', function() {
    const arr = document.getElementById('arreglo').value.split(',').map(Number);
...
document.getElementById('countVowelsButton').addEventListener('click', function() {
    const str = document.getElementById('vocal').value;
...
document.getElementById('sumArrayButton').addEventListener('click', function() {
    const arr = document.getElementById('sumA').value.split(',').map(Number);
...
document.getElementById('findMaxButton').addEventListener('click', function() {
    const arr = document.getElementById('maximo').value.split(',').map(Number);
